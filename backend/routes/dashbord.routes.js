...
import { calender, dashbordSubject, progressroute, userHighScoreQuizzes, userStreakRoute, recentActivity } from '../controllers/dashbord.controller.js'
...
dashBordRoute.get("/calender/details", isAuthenticated, calender)
dashBordRoute.get("/data/recent", isAuthenticated, recentActivity)
