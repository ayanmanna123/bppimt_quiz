...
const Footerreal = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-50 via-white to-slate-50 text-gray-800 border-t border-gray-200/60 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 bg-clip-text text-transparent mb-3">
            Stay Connected
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {footerSections.map((section, index) => (
            <motion.div
              ...
              className="group relative bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/60 hover:border-slate-300/60 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl"
            >
              {/* Glow effect */}
              <div
              ...
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="font-bold text-lg bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
                  {section.title}
                </h3>
              </div>
              ...
              <ul className="space-y-3">
                {section.links.map((link, linkIndex) => (
                  ...
                  >
                    <a
                      href={link.href}
                      className="group/link text-slate-600 hover:text-slate-800 transition-colors duration-300 flex items-center space-x-2"
                    >
                      <div
      ...
      {/* Bottom Section */}
      <div className="relative border-t border-gray-200/60 bg-white/40 backdrop-blur-sm">
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
                  className={`relative group p-3 rounded-2xl bg-slate-100 ${social.hoverColor} hover:text-white transition-all duration-300 hover:shadow-lg`}
      ...
      >
        <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-slate-200/60">
