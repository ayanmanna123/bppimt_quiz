...
const UnAuthorizeUser = () => {
  ...
  const updateUserStatus = async (id, userName, status) => {
    try {
      ...
      const statusMessage = status === 'accept' 
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-xl font-semibold text-gray-700">Loading pending users...</p>
        ...
        {sortedUsers.length === 0 ? (
          ...
          >
            ...
            <p className="text-gray-500 text-lg mb-6">
              {searchTerm ? "No users match your search criteria" : "No pending user registrations"}
            </p>
                    ...
                    >
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <div className={`w-3 h-3 rounded-full ${
                              user.role === 'student' ? 'bg-blue-400' : 'bg-purple-400'
                            }`}></div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-gray-600">
                              Applied: {new Date(user.createdAt || Date.now()).toLocaleDateString()}
                            </span>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          <Button
                            onClick={() => handleVerify(user._id, user.fullname)}
                          ...
                          >
                            ...
                            {processingIds.has(user._id) ? 'Processing...' : 'Approve'}
                          </Button>
                          <Button
